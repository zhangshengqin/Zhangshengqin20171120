...
import com.bwie.test.fjd.adapter.MyFragmentAdapter;
import com.bwie.test.fjd.fragment.ClassifyFragment;
import com.bwie.test.fjd.fragment.DiscoverFragment;
import com.bwie.test.fjd.fragment.HomeFragment;
import com.bwie.test.fjd.fragment.MyFragment;
import com.bwie.test.fjd.fragment.ShoppingFragment;
...
public class MainActivity extends FragmentActivity implements
    ...
    private Class fragmentArray[] = {HomeFragment.class, ClassifyFragment.class, DiscoverFragment.class, ShoppingFragment.class, MyFragment.class};
    private int imageViewArray[] = {R.drawable.tab_home_btn, R.drawable.tab_view_btn, R.drawable.tab_faxian_btn, R.drawable.tab_gouwu_btn, R.drawable.tab_wo_btn};
    private String textViewArray[] = {"首页", "分类", "发现", "购物车", "我的"};
    ...
    private void initPage() {
        ...
        ShoppingFragment fragment4 = new ShoppingFragment();
