...
import com.bwie.test.fjd.fenlei01.ChildShopActivity;
...
public class Child_gv_kindAdapter extends RecyclerView.Adapter<Child_gv_kindAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            iv_rcb = (ImageView) itemView.findViewById(R.id.iv_child_child);
            tv_rcb = (TextView) itemView.findViewById(R.id.tv_child_kind_childname);
        }
    }
}
