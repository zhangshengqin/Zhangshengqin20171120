...
import com.bwie.test.fjd.bean.shujubean.OrderBean;
...
//                Toast.makeText(context, "list.get(holder.getLayoutPosition()).getStatus():" + list.get(holder.getLayoutPosition()).getStatus(), Toast.LENGTH_SHORT).show();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            tv_order_id = (TextView) itemView.findViewById(R.id.tv_orderid);
            tv_price = (TextView) itemView.findViewById(R.id.tv_order_price);
            btn_quxiao = (Button) itemView.findViewById(R.id.btn_quxiao);
            btn_buy = (Button) itemView.findViewById(R.id.btn_buy);
            iv_order_over = (ImageView) itemView.findViewById(R.id.iv_over);
        }
    }
}
