...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.MyViewHolder> implements SearchCarView {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (dataBean.getList().size() > 0) {
            ...
            final CarChildAdapter carChildAdapter = new CarChildAdapter(contenxt, dataBean.getList(), tv_sumPrice,
                    tv_go_pay);
...
//                    tv_sumPrice.setText("¥  "+sumPrice);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            cb_parent = (CheckBox) itemView.findViewById(R.id.cb_car_item);
            tv = (TextView) itemView.findViewById(R.id.tv_car_dianpuName);
            recyclerView = (RecyclerView) itemView.findViewById(R.id.rcv_car_item);
        }
    }
}
