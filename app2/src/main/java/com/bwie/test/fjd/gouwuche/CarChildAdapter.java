...
public class CarChildAdapter extends RecyclerView.Adapter<CarChildAdapter.MyViewHolder> implements SearchCarView,
        DeleteCarView {
    ...
    public CarChildAdapter(Context context, List<SearchBean.DataBean.ListBean> list, TextView tv_sumPrice, TextView
            tv_go_pay) {
...
//                    onsetShopNum.shopNum(map,position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            iv_car = (ImageView) itemView.findViewById(R.id.iv_car_child);
            cb_child = (CheckBox) itemView.findViewById(R.id.cb_car_child);
            tv_title = (TextView) itemView.findViewById(R.id.tv_car_child_title);
            car_point = (AdPonitView) itemView.findViewById(R.id.car_point);
            tv_price = (TextView) itemView.findViewById(R.id.tv_car_price);
        }
    }
}
